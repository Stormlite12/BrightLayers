  ...
  return (
    <div className="w-auto h-auto bg-[#ecf0f1] overflow-hidden z-[-1] mt-[10%]">
      ...
      <div className="w-auto flex items-center justify-center h-[31.25rem] BrightLayers">
        <div className="w-[75.938rem] text-center">
      ...
      <div className="w-auto h-[20.25rem] flex flex-col mt-36 px-4">
        <div
          className="w-[53.938rem] h-[1.188rem] text-[#da5428] 
                      text-[25px] mx-auto font-semibold font-pSans
        ...
        <div
          className="w-[53.938rem] h-[364px] text-[#535353] 
      ...
      <div className="w-auto h-[324px] flex flex-col mt-36 px-4">
        <div
          className="w-[53.938rem] h-[1.188rem] mx-auto text-[#da5428] 
        ...
        <div className="flex justify-end">
          <a
            href="#examples"
            className="w-[9.438rem] h-[9.75rem] text-[#535353] text-xl font-semibold font-title underline leading-relaxed tracking-tight mb-4"
            id="service"
          >
            check services
          </a>
      ...
      <div className="w-[34.375rem] h-[8.563rem] text-[#303338] text-[2.813rem] font-semibold font-pSans leading-4 tracking-tight mt-10 ml-[146px]">
        Service We Provide For Your Brand
        <span className="text-[#303338] text-[66px] font-medium font-pSans leading-[77.88px] tracking-wide">
          {" "}
        </span>
        <span className="text-[#303338] text-[2.9375rem] font-bold font-pSans leading-[57.82px] tracking-wide">
          ツ
        </span>
        <AnimatedLogo />
      </div>
      ...
      <div className="w-full flex justify-center">
        <div className="w-[71.188rem] h-[19.563rem] text-center text-[#535353] font-medium font-title leading-snug tracking-tight text-[25px]">
      ...
      <div className="w-auto h-[2.269rem] text-center text-[#303338] text-[37px] font-semibold font-pSans leading-[43.66px] tracking-tight mt-80">
      ...
      <div className="flex justify-center">
        <div className="w-auto flex flex-row justify-between mt-[8.67rem] space-x-48">
          <img
            src={image26}
            alt="eureka"
            className="w-[16rem] h-[9.25rem] ml-10"
          />
          <img
            src={image25}
            alt="thames"
            className="w-[16rem] h-[4.313rem] mt-[2.5rem]"
          />
